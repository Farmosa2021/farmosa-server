...
async function recipeCrawler() {
	...
	for (var i in res.data) {
		...
		var imageUrl =
			"https://icook.tw/search/食材：".toString("utf8") + fruit_name;
		...
		request(
			...
			(error, res, body) => {
				...
				// console.log(body)
				const list = $("div div div div div");
				// const list = $(".bRMDJf");
				// console.log(list);
				for (let i = 0; i < 1; i++) {
					...
					const link = list.eq(i).find("h2").attr("data-title");
					console.log(link);
